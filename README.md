...
This version prevents the `Invalid time value` error by safely reading dates from both the app and Google Sheets. If a date from Google Sheets is saved as a full date/time value, the app converts it back to `YYYY-MM-DD`.
